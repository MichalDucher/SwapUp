...
const LatestListings = () => (
  <div className="latest-listings">
    ...
    <ul className="list-group">
      <li className="list-group-item">Listing 1</li> {/* Używamy klasy "list-group-item" dla każdego elementu listy */}
      <li className="list-group-item">Listing 2</li>
      <li className="list-group-item">Listing 3</li>
